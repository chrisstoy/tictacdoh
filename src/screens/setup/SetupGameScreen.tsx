...
export function SetupGameScreen({ onStartGame, onOptions }: Props) {
  ...
  return (
    <View className="h-max flex-1 flex-col" testID="setup-game-screen">
      ...
      <View className="flex-[0.5] flex " testID="choose-players-section">
        <View className="debug-red mx-2 h-1/4">
          <ChoosePlayersImage></ChoosePlayersImage>
        </View>

        <View className="debug-blue flex flex-row flex-auto" testID="player-choice">
      ...
      <View className="flex-[0.1] " testID="options-button">
        <OptionsButton
